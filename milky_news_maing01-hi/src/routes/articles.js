...
import ArticlesTitle from "../bricks/articles-title";
//@@viewOff:imports

const Articles = createVisualComponent({
  //@@viewOn:statics
  ...
  render() {
    ...
    function renderReady(articles, handleLoad) {
      return (
        <>
          <ArticlesTitle articles={articles} />
          <ArticleCreate onCreate={handleCreateArticle} />
          <ArticleList
            articles={articles}
